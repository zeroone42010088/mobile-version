...
<div class=h-title>
<h1 class="h1-main-page">РЕМОНТ СЕРВОДВИГАТЕЛЕЙ</h1>
<h2 class="h2-main-page">Ремонт настройка перемотка серводвигателей энкодеров резольверов сервомоторов сервоприводов</h2>
</div>
...
<div class=n-menu>
<ul class=menu>
<li><a style="background:linear-gradient(to top,#FF7E00,white)" href=index.html>главная</a></li>
...
<img class="main-motors" src=img/motors/how-it-works.jpg alt=motors>
...
<footer class=foot>
<div class=f-logo-l><a href=https://www.remontservo.ru/><img src=img/logo3.png alt=kerneltlt></a></div>
<div class=f-title>ООО "КЕРНЕЛ" Ремонт промышленной электроники</div>
<div class=f-logo-r><a href=https://www.remontservo.ru/><img src=img/logo3.png alt=kerneltlt></a></div>
</footer>
