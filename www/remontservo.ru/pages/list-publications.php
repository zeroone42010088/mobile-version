<?php 
$title = 'Список статей по теме ремонта электроники';
$keywords = 'Статьи, описание, ремонт электроники, сервомор, виды, оборудование, контроллер, обмотка';
$description = 'Тематика сайта - ремонт серводвигателей и промышленного оборудования. Список статей';
$classes = 'departure';
require '../header.php';
?>

<section class="cover" id="departure">
	<h1>Статьи по ремонту промышленной электроники и оборудования</h1>
</section>
